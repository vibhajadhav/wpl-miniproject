  ...
  <script>
    ...
    function displayResults(results) {
      ...
      results.forEach((medicine, index) => {
        ...
        resultItem.dataset.id = medicine.name + '_' + index; // Create a unique ID using name and index
    ...
    searchForm.addEventListener('submit', async function(e) {
      ...
      if (results.length === 1) {
        ...
        currentMedicine = {
          id: medicine.name + '_' + Date.now(), // Create a unique ID using name and timestamp
          name: medicine.name,
