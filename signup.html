    ...
    <div style="display: flex; width: 900px;">
        ...
        <div style="margin-left: 40px; padding: 20px; border-radius: 20px; border: 3px solid #3366FF; width: 550px; text-align: left;">
            <div style="background: #3366FF; color: white; padding: 80px; border-radius: 20px; text-align: left;">
                ...
                <input id="mobile" type="text" placeholder="Enter mobile number" style="width: 90%; padding: 14px; border: none; border-radius: 8px; font-size: 16px; margin-bottom: 15px;">
                ...
                <input id="password" type="password" placeholder="Enter password" style="width: 90%; padding: 14px; border: none; border-radius: 8px; font-size: 16px; margin-bottom: 15px;">

                <label for="confirm-password" style="display: block; font-size: 16px; margin-bottom: 5px;">Confirm password</label>
                <input id="confirm-password" type="password" placeholder="Confirm password" style="width: 90%; padding: 14px; border: none; border-radius: 8px; font-size: 16px; margin-bottom: 25px;">
                ...
                <p style="text-align: center; margin-top: 15px; font-size: 14px;">
                    Don't have an account? <a href="login.html" style="color: white; font-weight: bold; text-decoration: none;">Login</a>
                </p>
            </div>
        </div>
