...
<head>
  ...
  <style>
    /* Add this to your styles.css or in the head */
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-white shadow-sm">
    <div class="container">
      ...
      <!-- Updated Search Form -->
      <form id="medicineSearchForm" class="d-flex search-bar" style="width: 400px;">
        <input
          ...
          style="flex-grow: 1;" 
        />
        <button type="submit" class="btn btn-primary" style="width: 80px; padding: 6px 12px;">
          Search
        </button>
      </form>
      <div class="nav-icons">
  ...
  <div class="menu-bar">
    <ul>
      <li><a href="medicine-list.html">Medicine</a></li>
  ...
  <section class="py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-2 row-cols-md-4 g-4">
        <!-- Product 1 -->
        <div class="col">
          <a href="product1-details.html" class="text-decoration-none text-dark">
        ...
        <!-- Product 2 -->
        <div class="col">
          <a href="product2-details.html" class="text-decoration-none text-dark">
            <div class="card text-center">
        ...
        <!-- Product 3 -->
        <div class="col">
          <a href="product3-details.html" class="text-decoration-none text-dark">
            <div class="card text-center">
        ...
        <!-- Product 4 -->
        <div class="col">
          <a href="product4-details.html" class="text-decoration-none text-dark">
            <div class="card text-center">
  ...
  <section class="py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-2 row-cols-md-4 g-4">
        <!-- Example product 1 -->
        <div class="col">
          <a href="often1-details.html" class="text-decoration-none text-dark">
            <div class="card text-center">
        ...
        <!-- Example product 2 -->
        <div class="col">
          <a href="often2-details.html" class="text-decoration-none text-dark">
            <div class="card text-center">
  ...
  <script>
    // Function to update the pincode
    function updatePincode() {
      ...
      // For demo purposes, assume delivery is available
    ...
    document.querySelector('.pincode-input').addEventListener('input', function(e) {
      this.value = this.value.replace(/[^0-9]/g, '');
    });
    
    // Clear previous messages when modal is shown
    document.getElementById('pincodeModal').addEventListener('show.bs.modal', function() {
    ...
    // JavaScript for Medicine Search (using the form with id "medicineSearchForm")
    document.getElementById('medicineSearchForm').addEventListener('submit', function(event) {
      ...
      // Send search query to backend (search.php)
      fetch('search.php?query=' + encodeURIComponent(query))
        ...
        .then(data => {
          ...
          if (data.results.length === 0) {
            resultsContainer.innerHTML = '<div class="alert alert-info">No medicines found.</div>';
            return;
          }
          
          // Build HTML for search results using the "price" field
